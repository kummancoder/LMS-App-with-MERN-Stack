  ...
  return (
    <div className="relative bg-gradient-to-r from-blue-500 to bg-indigo-600 dark:from-gray-800 dark:to-gray-900 py-24 px-4 text-center">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-white text-4xl font-bold mb-4 mt-1">
        ...
        <Button className="bg-white dark:bg-blue-600 dark:text-white text-blue-600 rounded-full hover:bg-gray-200 ">
          Explore Courses
        </Button>
      </div>
    </div>
